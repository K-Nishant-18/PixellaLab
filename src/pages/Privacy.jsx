                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="space-y-12 text-lg leading-relaxed text-text-secondary">
                        <section>
                            ...
                            <p>
                                Welcome to Pixella Labs. We value your privacy and are committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you.
                            </p>
                        </section>

                        <section>
                            <h2 className="text-2xl font-bold text-text-primary mb-4">2. Data We Collect</h2>
                            <p className="mb-4">
                        ...
                        <section>
                            ...
                            <p>
                                If you have any questions about this privacy policy or our privacy practices, please contact us at: <a href="mailto:hello@pixellalabs.com" className="text-text-accent underline">hello@pixellalabs.com</a>
                            </p>
                        </section>
                    </div>
                </div>
